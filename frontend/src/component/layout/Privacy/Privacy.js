...
const Privacy = () => {
  return (
    <>
     <Helmet>
              <title>Myartworld/Privacy Policy</title>
      ...
      <div className="terms">
        <h3 className="th3">Privacy Policy Page</h3>
      ...
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to MyArtWorld.
      </p>
      <p>
      ...
      <p>
        ...
        <strong>Website</strong> refers to MyArtWorld, accessible from
        <a
          data-cke-saved-href="https://myartworld.in/"
          href="https://myartworld.in/"
        >
          https://myartworld.in/
        </a>
      </p>
